...
pub fn season_adjusted_morning_twilight(
    ...
    let adjustment =
        twilight_adjustments(AdjustmentDaytime::Morning, latitude, dyy, Twilight::General);
