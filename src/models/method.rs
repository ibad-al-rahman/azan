...
pub enum Method {
    ...
    /// uses standard Fajr and Ishaa angles of 18°.
    Karachi,
    ...
    /// Used in the UAE. Slightly earlier Fajr time and slightly later Ishaa
    /// time with angles of 18.2° for Fajr and Ishaa in addition to 3 minute
    ...
    /// Standard Fajr time with an angle of 18°. Slightly earlier Ishaa time with an angle of 17.5°.
    Kuwait,

    /// Same Ishaa interval as `ummAlQura` but with the standard Fajr time using an angle of 18°.
    Qatar,
    ...
    /// Institute of Geophysics, University of Tehran. Early Ishaa time with an angle of 14°.
